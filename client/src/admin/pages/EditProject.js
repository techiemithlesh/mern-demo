            ...
            <div className="w-full max-w-4xl mx-auto my-4">
                <form onSubmit={handleSubmit}
                    ...
                    <div className="mb-4">
                        ...
                        <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="technologies" type="text" placeholder="Enter project technologies"
                            value={
